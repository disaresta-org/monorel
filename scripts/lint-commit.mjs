#!/usr/bin/env node
// Lints commit messages with @conventional-commits/parser.
//
// monorel itself doesn't infer releases from commit messages
// (changesets do that explicitly). But following Conventional Commits
// for the commit body keeps CHANGELOG entries consistent and machine-
// readable, and matches the convention every external repo monorel
// integrates with.
//
// Usage:
